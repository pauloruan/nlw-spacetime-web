  ...
  return (
    <main className="grid min-h-screen grid-cols-2 ">
      ...
      <div className="flex flex-col justify-between items-start overflow-hidden px-28 py-16 relative border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover">
        ...
        {/* sign in */}
        <a href="" className="flex items-center gap-3 text-left hover:text-gray-50 transition-colors" title="login">
        ...
        <div className="space-y-5">
          ...
          <a
            href=""
            className="inline-block rounded-full px-5 py-3 font-alt text-sm uppercase leading-none text-black font-bold bg-green-500 hover:bg-green-600"
          >
            CADASTRAR LEMBRANÇA
          </a>
        </div>
        ...
        <div className="text-sm leading-relaxed text-gray-200">
          Feito com 💜 no NLW da{" "}
          <a href="https://rocketseat.com.br" className="underline hover:text-gray-100" target="_blank" rel="noopener">
            Rocketseat
          </a>
        </div>
      </div>
